...
public class LangileGUI extends JFrame {
	...
	private JButton getBoton7() {
		if (jButtonCreateQuote == null) {
			jButtonCreateQuote = new JButton();
			jButtonCreateQuote.setText(ResourceBundle.getBundle("Etiquetas").getString("CreateQuote"));
			jButtonCreateQuote.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
	...
	private JButton getBoton8() {
		if (jButtonDeleteEvent == null) {
			jButtonDeleteEvent = new JButton();
			jButtonDeleteEvent.setText(ResourceBundle.getBundle("Etiquetas").getString("DeleteEvent"));
	...
	private JButton getBoton11() {
		if (jButtonMezuaIkusi == null) {
			...
			jButtonMezuaIkusi.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					JFrame a = new MezuakIkusiGUI(lan);
	...
	private JButton getBtnGertaeraBikoiztu() {
		if (btnGertaeraBikoiztu == null) {
			...
			btnGertaeraBikoiztu.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					JFrame a = new GertaeraBikoiztuGUI();
					a.setVisible(true);
				}
			});
		}
